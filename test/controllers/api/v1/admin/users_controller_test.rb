...
class Api::V1::Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "POST /api/v1/admin/users creates user" do
    rut = valid_rut
    ...
    post "/api/v1/admin/users",
      params: {
        ...
        teams_ids: [],
        consents: { lgpd: true, terms: true, photo_usage: true }
      }.to_json,
      headers: @headers
  ...
  test "POST /api/v1/admin/users fails without photo consent" do
    post "/api/v1/admin/users",
      params: {
        rut: valid_rut,
        phone: "+56991234567",
        ...
        birth_year: 1990,
        photo: valid_photo_base64,
        consents: { lgpd: false, terms: true, photo_usage: true }
      }.to_json,
      headers: @headers
  ...
  test "POST /api/v1/admin/users fails with invalid rut" do
    post "/api/v1/admin/users",
      params: {
        rut: "123456",
        phone: "+56991234567",
